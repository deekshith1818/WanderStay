const sampleListings = [
  ...
  },
  {
    ...
    {
      filename:"listingImage",url:"https://images.unsplash.com/photo-1501785888041-af3ef285b470?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHRyYXZlbHxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60",
    },
    price: 1200,
  ...
  },
  {
    ...
    image: {
      filename:"listingImage",url:"https://images.unsplash.com/photo-1571896349842-33c89424de2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8aG90ZWxzfGVufDB8fDB8fHww&auto=format&fit=crop&w=800&q=60",
    },
    price: 1000,
    location: "Aspen",
    country: "United States",
  },
  {
    ...
    image: {
      filename:"listingImage",url:"https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aG90ZWxzfGVufDB8fDB8fHww&auto=format&fit=crop&w=800&q=60",},
    price: 2500,
    location: "Florence",
    country: "Italy",
  },
  {
    ...
    image: {
      filename:"listingImage",url:"https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGhvdGVsc3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60",},
    price: 800,
    location: "Portland",
    country: "United States",
  },
  ...
  },
  {
    ...
    image: {filename:"listingImage",url:"https://images.unsplash.com/photo-1602088113235-229c19758e9f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8YmVhY2glMjBzaWRlJTIwZGVzY2VudGFuY3l8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60",},
    price: 1100,
    location: "Cotswolds",
  ...
  const validateData = (sampleListings) => {
    const invalidEntries = sampleListings.filter((item) => !item.title);
    if (invalidEntries.length > 0) {
        console.error("Invalid entries found:", invalidEntries);
       // throw new Error("Some entries are missing the required 'title' field.");
    }else{
        console.log("no");
    }
};
